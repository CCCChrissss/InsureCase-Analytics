...
- 已建立跨年度 trial DB：ROC 114 一月 112 筆加 ROC 115 492 筆，共 604 筆。
- 已在 trial DB 產生 604 筆規則式摘要。
- 已確認正式展示 DB 仍維持 ROC 115 共 492 筆，尚未切換為跨年度資料。
- 已發現 ROC 114 一月資料中有 32 筆案號、爭議類型與整理後路徑出現亂碼，需先修正資料品質。
- 尚未蒐集 ROC 114 完整年度或 ROC 116 資料。
...
- 跨年度案件數正確。
- 年度篩選正常。
- ROC 114 亂碼資料修正後，trial DB 年度分布仍為 ROC 114 = 112、ROC 115 = 492，且異常字元檢查為 0。
